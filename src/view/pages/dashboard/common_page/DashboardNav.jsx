...
function DashboardNav({ isOpen, setIsOpen }) {
    ...
    return (
        <nav className="bg-white border-b border-black/10 dark:border-cyan-950 dark:bg-gray-900">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <div className='w-full md:w-44 flex justify-between'>
                    ...
                    <button onClick={() => setIsOpen(!isOpen)} className={`${isOpen ? 'block' : 'hidden'} h-10`}>
                        <ClearIcon className="text-gray-500 rounded-lg  hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" fontSize="large" />
                    </button>
                </div>
